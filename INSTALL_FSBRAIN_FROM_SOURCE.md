...
While fsbrain is written in plain R, some of its dependencies are
written in C++, and building from source thus requires a compiler and
the specific libraries required to build each dependency. These are
known as system dependencies.
