...
We will use example data that comes with nitools throughout this manual. Feel free to replace the subjects_dir and subjects_list with data from your study.
...
The visualization functions are based on OpenGL using the rgl package. See the rgl documentation for the requirements. Under MacOS, you will need to have XQuartz installed.

## Rendering surfaces and morphometry data
