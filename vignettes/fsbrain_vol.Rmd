...
These types of visualizations are most suitable for interactive use. They rely on a binary definition of *foreground* versus *background* voxels to show the contents of a 3D image. For most grayscale images, especially pre-processed ones, simple thresholding is enough to identify the foreground.
