...
The movie will be saved under the name 'fsbrain_subject1_thickness_white.gif' in your home directory. You can tweak it in whatever external software you like if needed. E.g., if you would like the animation to loop forever, you could use the *convert* command line utility that comes with ImageMagick from your OS shell:
