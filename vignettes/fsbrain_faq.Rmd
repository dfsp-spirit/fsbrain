...
Note that your output resolution settings now count for each of the single images. This means that you will get quite high resolution output in combination with the tight layout. This makes the function ideal for producing plots for publications.
...
```{r, eval = FALSE}
vislayout.from.coloredmeshes(cm, style='shiny', view_angles = get.view.angle.names('t9'), output_img = "~/fig1.png")
```
