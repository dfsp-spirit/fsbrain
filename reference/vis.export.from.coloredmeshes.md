...
required, one can use `vislayout.from.coloredmeshes` instead.
...
- horizontal:
  ...
  logical, whether to plot the colorbar horizontally (TRUE) or
  vertically (FALSE). Pass 'NULL' to force no colorbar at all.
...
This function should not be used anymore, it will be deprecated soon.
Please use the
