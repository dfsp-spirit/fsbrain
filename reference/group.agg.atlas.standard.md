...
e.g., compute the mean thickness value over all regions in an atlas for
all subjects.
...
- hemi, :
  ...
  loaded. If set to 'both', combined data for 'lh' and 'rh' will be
  used.
...
- fwhm, :
  ...
  string. The smoothing setting which was applied when mapping data to
  the template subject. Usually one of '0', '5', '10', '15', '20', or
  '25'.
...
- template_subject, :
  ...
  string. The template subject name. Defaults to 'fsaverage'. Must have
  its data in subjects_dir.
