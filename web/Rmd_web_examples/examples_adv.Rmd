...
You can use fsbrain to plot data for many subjects at once. First we define our subjects directory and a subjects list:

```{r}
sjd = "~/data/study1";                           # set SUBJECTS_DIR

sjl = c('subject1', 'subject2', 'subject3');                            # specify subjects list manually
sjl2 = read.md.subjects("~/data/study1/subjects.txt", header = FALSE);  # read from ASCII subjects file (one subject per line)
sjl3 = read.md.subjects.from.fsgd("~/data/study1/subjects.fsgd");  # read from FSGD file
```
