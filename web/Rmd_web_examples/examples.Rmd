...
You can customize the look of the outlines (or region borders) by passing a list of extra arguments to `annot.outline` instead of a logical value, see the documentation for details. Here is an example that draws a green border around the middletemporal region:

```{r rgl=TRUE, dev='png'}
vis.subject.annot(sjd ,sj, 'aparc', outline=list('outline_color'='#00FF00', 'limit_to_regions'=c('middletemporal'), expand_inwards=2L), surface="inflated", views="sd_lateral_lh")
```
